<template>
    ...
    <div class="relative max-w-7xl mx-auto lg:grid lg:grid-cols-5">
        ...
        <div class="max-w-lg mx-auto lg:max-w-none">
            ...
            <div>
                <button type="submit" class="inline-flex justify-center py-3 px-6 border border-transparent shadow-sm text-base font-medium rounded-md text-white bg-secondary hover:bg-primary focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-secondary">
                Submit
                </button>
            </div>
            </form>
